...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/clubPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'clubPage')
              : ClubPageWidget(),
        ),
        FFRoute(
          name: 'profilePage',
        ...
        FFRoute(
          ...
          path: '/clubDetailsPage',
          builder: (context, params) => ClubDetailsPageWidget(
            clubReference: params.getParam(
              'clubReference',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['clubs'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/createEvent',
          asyncParams: {
            'clubRef': getDoc(['clubs'], ClubsRecord.fromSnapshot),
          },
          builder: (context, params) => CreateEventWidget(
            clubRef: params.getParam(
              'clubRef',
              ParamType.Document,
            ),
          ),
